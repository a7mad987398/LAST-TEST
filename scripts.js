document.addEventListener('DOMContentLoaded', () => {
    ...
    const staffMembers = [
        ...
        },
        {
            ...
            name: 'HAZHA',
            photo: 'img/hazha.jpg',
            about: 'سڵاو من هاژە تەمەنم ١٦ ساڵە قوتابیم لە پۆلی ١١ی وێژەیی و حەزم لێیە لە داهاتوودا ببمە پارێزەر بۆ نەهێشتنی خراپەکاری و ماوەی نزیکەی ساڵێکە دیسکۆرد بەکار ئەهێنم و لەوکاتەوە ستافم لە سێرڤەری Last X Village ئەوێم هەڵبژارد و هەر خزمەتی ئەوێش ئەکەم حەزم لە یەکسانی و دادپەروەرییە ڕقیشم لە بوختان و درۆ و قسەی ڕەقە'
        },
    ];
